...
class Fbf_Importer {
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_action('wp_ajax_fbf_importer_reset_batch', $plugin_admin_ajax, 'fbf_importer_reset_batch');
        $this->loader->add_action('wp_ajax_nopriv_fbf_importer_reset_batch', $plugin_admin_ajax, 'fbf_importer_reset_batch');
	}
